...
<html lang="en">
  <head>
    <title>Ultras - Clothing Store eCommerce Store  </title>
    <meta charset="utf-8">
                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <li class="menu-item has-sub">
                        <a href="index.html" class="item-anchor d-flex align-item-center" data-effect="Home">Home
                      ...
                      <li class="menu-item has-sub">
                        <a href="shop.html" class="item-anchor d-flex align-item-center" data-effect="Shop">Shop
                          <!-- <i class="icon icon-chevron-down"></i> -->
                        </a>
                        <!-- <ul class="submenu">
                      ...
                      <li class="menu-item has-sub">
                        <a href="#" class="item-anchor d-flex align-item-center" data-effect="Pages">Pages
                          <!-- <i class="icon icon-chevron-down"></i> -->
                        </a>
                        <!-- <ul class="submenu">
                      ...
                      <li class="menu-item has-sub">
                        <a href="blog.html" class="item-anchor d-flex align-item-center" data-effect="Blog">Blog
                          <!-- <i class="icon icon-chevron-down"></i> -->
                        </a>
                        <!-- <ul class="submenu">
    ...
    <div id="footer-bottom">
      <div class="container">
        <div class="d-flex align-items-center flex-wrap justify-content-between">
          <div class="copyright">
            <p>Developed by <a href="https://cyrusappsite.wordpress.com/">Cyrus Apenteng/a> Distributed by <a href="https://themewagon.com">ThemeWagon</a>
            </p>
          </div>
